...
function handleShopIndex(stageIndex) {
  ...
  const productCards = products.map(p => `
    <div class="pm-product">
      <img class="pm-product-img" src="/shop/image?file=${encodeURIComponent(p.img)}" alt="${escapeHtml(p.name)}" />
...
.pm-product-img{background:#1a1200;width:100%;height:120px;object-fit:contain;display:block}
